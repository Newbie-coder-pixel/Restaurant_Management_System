...
// - Tab atas: "Buat Reservasi" | "Reservasi Saya"
// - Form langsung di halaman (bukan lewat AI)
// - List riwayat booking milik user yang login
// - Real-time status update via Supabase stream
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: TabBar(
          ...
          indicatorWeight: 2.5,
          tabs: const [
            Tab(icon: Icon(Icons.add_circle_outline, size: 18),
              text: 'Buat Reservasi'),
      ...
      Expanded(
        child: TabBarView(
          controller: _tabCtrl,
          children: [
            // Tab 0: Form buat booking
            _BookingForm(
              isDesktop: isDesktop,
              onSuccess: () {
                // Setelah berhasil booking, pindah ke tab riwayat
...
class _BookingFormState extends ConsumerState<_BookingForm> {
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            child: const Icon(Icons.check_circle, color: Color(0xFF4CAF50), size: 36)),
          const SizedBox(height: 16),
          const Text('Reservasi Berhasil!', style: TextStyle(
            fontFamily: 'Poppins', fontSize: 17, fontWeight: FontWeight.w700,
            color: Color(0xFF1A1A2E))),
          const SizedBox(height: 8),
          const Text('Reservasi kamu sudah dikonfirmasi.\nCek tab "Reservasi Saya" untuk detailnya.',
        ...
        actions: [
          TextButton(
            ...
            child: const Text('OK', style: TextStyle(
              fontFamily: 'Poppins', color: Color(0xFF0F3460),
  ...
  Widget build(BuildContext context) {
    ...
    return branchesAsync.when(
      ...
      data: (branches) {
        // Auto-select jika hanya 1 cabang
        if (branches.length == 1 && _selectedBranchId == null) {
          _selectedBranchId = branches[0]['id'] as String;
        }

        final selectedBranch = branches.isEmpty ? null
            : branches.where((b) => b['id'] == _selectedBranchId)
                .cast<Map<String, dynamic>?>()
                .firstOrNull;

        final openTime  = (selectedBranch?['opening_time'] as String?)
            ?.substring(0, 5) ?? '10:00';
        final closeTime = (selectedBranch?['closing_time'] as String?)
            ?.substring(0, 5) ?? '22:00';
        ...
        Widget formContent = Column(
          ...
          children: [
              ...
              _dropdown(
                ...
                items: branches.map((b) => DropdownMenuItem<String>(
                  ...
                  child: Text(b['name'] as String,
                    style: const TextStyle(fontFamily: 'Poppins', fontSize: 14)))).toList(),
                onChanged: (v) => setState(() => _selectedBranchId = v)),
            const SizedBox(height: 20),

            // ── Tanggal & Jam (row di desktop)
            if (widget.isDesktop)
            ...
            TextField(
              ...
              decoration: _inputDeco('Contoh: alergi kacang, kursi tinggi untuk bayi...', null)),
              ...
              child: Container(
                ...
                child: Center(child: _submitting
                  ...
                  : const Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      SizedBox(width: 8),
                      Text('Buat Reservasi', style: TextStyle(
  ...
  Widget _infoChip(IconData icon, String label) => Container(
    ...
    child: Row(children: [
      ...
      Text(label, style: const TextStyle(
        ...
        fontWeight: FontWeight.w600, color: Color(0xFF0F3460))),
    ]));
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton<String>(
        ...
        style: const TextStyle(
          fontFamily: 'Poppins', fontSize: 14, color: Color(0xFF1A1A2E)))));
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: _selectedDate != null
              ? const Color(0xFF0F3460) : const Color(0xFFE5E7EB))),
          child: Row(children: [
            Icon(Icons.calendar_today_outlined, size: 18,
              color: _selectedDate != null
                ? const Color(0xFF0F3460) : const Color(0xFF6B7280)),
            const SizedBox(width: 10),
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: _selectedTime != null
              ? const Color(0xFF0F3460) : const Color(0xFFE5E7EB))),
          child: Row(children: [
  ...
  Widget _guestPicker() => Row(children: [
    ...
    Expanded(child: Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text('$_guestCount orang', style: const TextStyle(
...
class _BookingHistory extends ConsumerWidget {
  ...
  Widget _emptyState() => Center(
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      const SizedBox(height: 20),
      const Text('Belum Ada Reservasi', style: TextStyle(
        fontFamily: 'Poppins', fontSize: 17, fontWeight: FontWeight.w700,
        color: Color(0xFF1A1A2E))),
      const SizedBox(height: 8),
...
class _BookingCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final branchName = (booking['branches'] as Map?)?['name'] ?? 'Restoran';
    ...
    final isLive     = _status == 'pending' || _status == 'confirmed';
