...
class _QrMenuScreenState extends ConsumerState<QrMenuScreen>
  ...
  // Parse raw Supabase rows into domain objects
          ...
          Expanded(
            child: menuAsync.when(
              ...
              data: (rawItems) {
                ...
                final filteredGroups = <String, List<MenuItem>>{};
                for (final cat in categories) {
                  if (selectedCategory != null && cat != selectedCategory) {
                    continue;
                  }
                  final items = grouped[cat]!.where((item) {
                  ...
                  if (items.isNotEmpty) filteredGroups[cat] = items;
                }
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final icon = _categoryIcons[cat] ?? Icons.fastfood_outlined;
