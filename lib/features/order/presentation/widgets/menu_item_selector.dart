...
class _MenuItemSelectorState extends State<MenuItemSelector> {
  ...
  double get _cartPrice => _cart.entries.fold(0, (a, e) {
        final item = _allItems.firstWhere((m) => m.id == e.key, orElse: () => _allItems.first);
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              setState(() {
                if (_cart.containsKey(item.id)) _cart[item.id]!.notes = '';
              });
              Navigator.pop(ctx);
            },
          ...
          ElevatedButton(
            onPressed: () {
              setState(() {
                if (_cart.containsKey(item.id)) _cart[item.id]!.notes = ctrl.text.trim();
              });
              Navigator.pop(ctx);
            },
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(
                                fontFamily: 'Poppins', fontWeight: FontWeight.w700, fontSize: 13, color: AppColors.accent),
                          ),
                          ...
                          qty == 0
                              ? SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: const Text('+ Tambah', style: TextStyle(fontFamily: 'Poppins', fontSize: 12)),
                                  ),
                                )
                              : Column(children: [
                                  Row(children: [
                                    ...
                                    Expanded(
                                      child: Center(
                                        child: Text('$qty', style: const TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700)),
                                      ),
                                    ),
                                    IconButton(
                                      constraints: const BoxConstraints(minWidth: 28, minHeight: 28),
            ...
            if (_cartTotal > 0)
              Container(
                ...
                child: Row(children: [
                  ...
                  const Text('item dipilih', style: TextStyle(fontFamily: 'Poppins', color: Colors.white70)),
                  const Spacer(),
                  Text(
                    'Rp ${_cartPrice.toStringAsFixed(0)}',
                    style: const TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w700, color: Colors.white, fontSize: 16),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    child: _isSubmitting
                        ...
                        : const Text('Kirim ke Dapur', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w600)),
                  ),
                ]),
              ),
          ]);
