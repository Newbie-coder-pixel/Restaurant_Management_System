        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Flexible(child: SingleChildScrollView(child: Column(
              ...
              children: [
                ...
                SizedBox(width: double.infinity, child: ElevatedButton.icon(
                  onPressed: _nameCtrl.text.trim().isEmpty ? null : _findAvailableTable,
                  ...
                  label: Text(
                    _isSearching ? 'Mencari meja...' : 'Cek & Pilihkan Meja Otomatis',
                    style: const TextStyle(
                ...
                if (_assignError != null)
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      const SizedBox(width: 12),
                      Expanded(child: Text(_assignError!,
                        style: const TextStyle(
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Contoh: Ulang tahun, minta dekorasi bunga...',
            ...
            Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              ...
              const SizedBox(width: 8),
              ElevatedButton.icon(
                onPressed: _assignedTable == null ? null : _submitBooking,
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF1A1A2E),
                  foregroundColor: Colors.white,
