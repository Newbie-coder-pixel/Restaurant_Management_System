...
class _EditBookingDialogState extends State<EditBookingDialog> {
  ...
  bool _isWaitlistMode = false; // true if all tables are full → offer waitlist
  ...
  Future<void> _findAvailableTable() async {
    ...
    try {
      ...
      if (available.isEmpty) {
        setState(() {
          _assignError    = 'All tables for $_guests guests are fully booked at that time.';
              ...
              const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Edit Reservation',
                    style: TextStyle(
                        ...
                        fontSize: 18)),
                Text('Update reservation details',
                    style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 12,
